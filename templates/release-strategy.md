...
This document defines the release policy for **@REPOSITORY@**. The
...
`@DEFAULT_BRANCH@`. The default branch is the integration and release source;
...
The committed base version comes from @VERSION_SOURCE@. A release preparation PR
